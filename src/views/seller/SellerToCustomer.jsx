        ...
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto">
              <div className="flex text-xl justify-between items-center p-4 md:p-0 md:px-3 md:pb-3 text-black">
                <h2 className="relative right-0 translate-x-1/2 flex gap-2 items-center border-[1px] border-b-black pb-2">
                  <AiOutlineMessage />
                  Customers
                </h2>
                <span
              ...
              {customers.map((c, i) => (
                <Link
                  ...
                  className={`h-[60px] flex justify-start gap-2 items-center text-back px-2 py-2 rounded-xl cursor-pointer bg-green-400  `}
                >
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            <div className="flex justify-between items-center">
              ...
              <div
                onClick={() => setShow(!show)}
                className="w-[35px] flex md:hidden h-[35px] rounded-sm bg-green-500 shadow-lg hover:bg-green-400 duration-200 justify-center cursor-pointer items-center text-white"
              >
                <span>
                  <FaList />
                </span>
