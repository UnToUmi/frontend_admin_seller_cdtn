...
export const get_discount_product = createAsyncThunk(
  "product/get_discount_product",
  async (
    ...
    try {
      const { data } = await api.get(
        `/discount-products-get?page=${page}&&searchValue=${searchValue}&&perPage=${perPage}`,
        { withCredentials: true }
      );
      console.log(data);
      return fulfillWithValue(data);
...
export const productReducer = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(get_discount_product.fulfilled, (state, { payload }) => {
        state.discountProducts = payload.discountProducts;
        state.successMessage = payload.message;
        state.totalDiscountProduct = payload.totalDiscountProduct;
      })
